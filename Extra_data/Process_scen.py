...
for i in range(len(lines)):
    ...
    if "CRE" in line:
        ...
        flights.append({"time": time, "call_sign": call_sign, "aircraft_type": aircraft_type, "origin_icao": origin, "destination_icao": destination})
...
airport_csv = './Extra_data/flat-ui__data-Mon Feb 24 2025.csv'  # adjust the path as required
...
print(df)
df.to_excel("./Extra_data/flights.xlsx")